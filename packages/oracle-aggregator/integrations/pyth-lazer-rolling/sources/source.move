...
module oracle_aggregator_pyth_lazer_rolling_integration::source;
...
public struct PYTH_LAZER_ROLLING() has drop;
...
public(package) fun source_cap(source: &Source<PYTH_LAZER_ROLLING>): &SourceCap {
    abort 404
}
...
public(package) fun assert_version(source: &Source<PYTH_LAZER_ROLLING>) {
    abort 404
}
