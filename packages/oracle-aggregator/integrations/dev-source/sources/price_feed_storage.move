...
module oracle_aggregator_dev_integration::price_feed_storage;

use oracle_aggregator_dev_integration::source::DEV;
...
use fun oracle_aggregator_dev_integration::source::source_cap as Source.source_cap;
use fun oracle_aggregator_dev_integration::source::assert_version as Source.assert_version;
...
public fun update_price_feed<VendorKey, ADMIN_OR_ASSISTANT>(
    source: &Source<DEV>,
